...
## Ví dụ
- Ví dụ với game Mario. Trong khung hình của game, có một số hành vi được thêm vào để giúp trò chơi hấp dẫn trực quan hơn.
...
- Phần trình bày hoạt động như điều khiển trong MVC, nhưng có một số khác biệt. 
...
## Cách hoạt động
1) Hành động của người dùng được truyền xuống cho phần trình bày. Nếu các hành động này bao gồm dữ liệu, chỉ các phiên bản nguyên thủy của dữ liệu mới được chuyển 
2) Tầng trình bày sau đó sẽ sửa đổi trạng thái nội bộ của nó và cập nhật tầng mô hình nếu cần
3) Khi mô hình được cập nhật, nó sẽ kich hoạt các sự kiện được truyền lại cho tầng trình bày 
4) Một khi tầng trình bày có bản cập nhật của tầng mô hình, điều tiếp theo là nó sẽ đi cập nhật khung nhìn. Bước này chỉ gửi dữ liệu nguyên thủy lên khung nhìn
---
