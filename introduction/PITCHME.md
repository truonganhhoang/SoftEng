...
- Khi gỡ lỗi(debug), ta nên đặt một điểm dừng.
- Sau đó, ta kiểm tra sự khác biệt giữa các biến trong chương trình và trạng thái của chúng. 
...
- Đối với ngôn ngữ lập trình kiểu tĩnh, ta phải khai báo 1 biến kèm kiểu dữ liệu cụ thể của nó.
- Và sau đó, trình biên dịch sẽ đi kiểm tra xem mọi thao tác với biến đó có thích hợp với kiểu dữ liệu của nó hay không.
